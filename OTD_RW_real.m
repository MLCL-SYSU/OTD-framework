...
path = ['360dataset\sensory\tile\', file, '_tile.csv'];
...
for e = 1 : E
    ...
    for t = 1 : T
        ...
        DX_g_q = (-W3_vector(:, t) .* R_vector) * (g_q(t) > 0) / sqrt(FoV_tiles_num(t));
...
%%
file_name_format = 'OTD_RW_real_%s_T(%d)_E(%d)_noise(mu_%d)_B(mu_%d_sigma_%d)_Q(%d)_';
